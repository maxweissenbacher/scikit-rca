...
To create your package, you need to clone the ``rca_fmri`` repository:

.. prompt:: bash $

  git clone https://github.com/scikit-learn-contrib/rca_fmri.git

Before to reinitialize your git repository, you need to make the following
changes. Replace all occurrences of ``rca_fmri``, ``rca_fmri``, or
``rca_fmri`` with the name of you own project. You can find all the
