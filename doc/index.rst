.. rca_fmri documentation master file, created by
...
**Useful links**:
`Source Repository <https://github.com/scikit-learn-contrib/rca_fmri>`__ |
`Issues & Ideas <https://github.com/scikit-learn-contrib/rca_fmrik/issues>`__ |

This is the documentation for the `rca_fmri` to help at extending
